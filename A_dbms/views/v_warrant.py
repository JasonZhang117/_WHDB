...
def warrant_scan(request, warrant_id):  # house_scan房产预览
    ...
    form_warrant_edit = forms.WarrantEditForm(form_warrant_edit_date)
    form_owership_add_edit = forms.OwerShipEditForm()

    print('form_owership_add_edit:', form_owership_add_edit)
