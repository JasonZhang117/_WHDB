...
class AgreeAddForm(dform.ModelForm):
    class Meta:
        model = models.Agrees
        fields = ['lending', 'branch', 'agree_typ',
                  'guarantee_typ', 'agree_copies', 'agree_amount']
        # widgets = {
        #     'article': dform.Select(attrs={'class': 'form-control'}),
        ...
        #     'agree_copies': dform.NumberInput(attrs={'class': 'form-control',
        #                                              'placeholder': '合同份数'}),
        #     'agree_typ': dform.Select(attrs={'class': 'form-control'}),
        #     'agree_amount': dform.NumberInput(attrs={'class': 'form-control',
        #                                              'placeholder': '合同金额（元）'})
        # }
