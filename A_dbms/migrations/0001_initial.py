# Generated by Django 2.1.3 on 2019-01-05 06:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flow_loan', models.FloatField(default=0, verbose_name='_流贷余额')),
                ('accept_loan', models.FloatField(default=0, verbose_name='_承兑余额')),
                ('back_loan', models.FloatField(default=0, verbose_name='_保函余额')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('draft_typ', models.IntegerField(choices=[(1, '银行承兑汇票'), (2, '商业承兑汇票'), (3, '支票')], default=1, verbose_name='票据种类')),
                ('draft_detail', models.TextField(verbose_name='汇票描述')),
                ('draft_owner', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='draft_custome', to='A_dbms.Customes', verbose_name='所有权人')),
            ],
            options={
                'db_table': 'dbms_draft',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('draft', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='extend_receiveable', to='A_dbms.Draft', verbose_name='票据')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.ForeignKey(limit_choices_to={'counter_typ__in': [1, 2]}, on_delete=django.db.models.deletion.PROTECT, related_name='lending_summary', to='A_dbms.Articles', verbose_name='项目纪要')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('implement', models.IntegerField(choices=[(1, '未归档'), (2, '暂存风控'), (3, '已归档')], default=1, verbose_name='_归档状态')),
                ('provide_status', models.IntegerField(choices=[(1, '在保'), (2, '解保'), (3, '代偿')], default=1, verbose_name='_放款状态')),
                ('provide_repay_sum', models.FloatField(default=0, verbose_name='_还款金额')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('receive_owner', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='receive_custome', to='A_dbms.Customes', verbose_name='所有权人')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('credit_model', models.IntegerField(choices=[(1, '流动资金贷款担保'), (2, '银行承兑汇票担保'), (3, '保函担保'), (4, '综合授信额度担保（含流贷、银承、保函）')], default=1, verbose_name='授信类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vehicle_owner', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='vehicle_custome', to='A_dbms.Customes', verbose_name='所有权人')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('warrant_typ', models.IntegerField(choices=[(1, '房产'), (2, '土地'), (11, '应收'), (21, '股权'), (31, '票据'), (41, '车辆'), (51, '动产'), (99, '他权')], default=1, verbose_name='权证类型')),
        ...
        migrations.AddField(
            model_name='notify',
            name='notifyor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='notifyor_employee', to=settings.AUTH_USER_MODEL, verbose_name='_创建者'),
        ),
