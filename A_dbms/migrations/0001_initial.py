# Generated by Django 2.1 on 2020-08-04 23:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agree_term_typ', models.IntegerField(choices=[(1, '月'), (11, '日'), (21, '年')], default=1, verbose_name='期限单位')),
                ...
                ('repay_method', models.IntegerField(blank=True, choices=[(11, '按月付息、到期一次还本'), (21, '等额本息'), (31, '按月付息、分期还本'), (41, '到期一次还本付息')], null=True, verbose_name='还款方式')),
                ...
                ('investigation_fee', models.FloatField(default=0, verbose_name='调查费率(%)')),
                ('agree_sign_date', models.DateField(blank=True, null=True, verbose_name='签批日期')),
                ('charge', models.FloatField(default=0, verbose_name='预收保费（元）')),
                ...
                ('supplementary', models.TextField(blank=True, null=True, verbose_name='补充协议')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('review_year', models.IntegerField(default=2020, verbose_name='评审年份')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article_repay_method', models.IntegerField(blank=True, choices=[(11, '按月付息、到期还本'), (21, '等额本息'), (31, '按月付息、分期还本'), (41, '到期一次还本付息')], null=True, verbose_name='还款方式')),
                ...
                ('article_state', models.IntegerField(choices=[(1, '待反馈'), (2, '已反馈'), (3, '待上会'), (4, '已上会'), (5, '已签批'), (51, '已放款'), (52, '已放完'), (55, '已解保'), (61, '待变更'), (99, '已注销')], default=1, verbose_name='项目状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('petty_loan', models.FloatField(default=0, verbose_name='_过桥贷余额')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('linkman', models.CharField(max_length=64, verbose_name='联系人')),
                ('contact_num', models.CharField(max_length=32, verbose_name='联系电话')),
                ('plan_date', models.DateField(blank=True, null=True, verbose_name='台账日期')),
                ('review_plan_date', models.DateField(blank=True, null=True, verbose_name='保后计划')),
                ('plan_sty', models.IntegerField(blank=True, choices=[(1, '现场检查'), (11, '电话回访'), (61, '补调替代'), (62, '尽调替代'), (91, '无需保后')], null=True, verbose_name='计划方式')),
                ('review_state', models.IntegerField(choices=[(1, '待保后'), (11, '待报告'), (21, '已完成'), (81, '自主保后'), (91, '无需保后')], default=21, verbose_name='_保后状态')),
                ...
                ('book', models.TextField(blank=True, null=True, verbose_name='专员台账')),
                ...
                ('classification', models.IntegerField(choices=[(11, '正常'), (21, '关注'), (31, '次级'), (41, '可疑'), (51, '损失')], default=11, verbose_name='五级分类')),
                ...
                ('custom_dun_state', models.IntegerField(choices=[(1, '正常'), (11, '被告'), (99, '注销')], default=11, verbose_name='_风险分类')),
                ('credit_amount', models.FloatField(default=0, verbose_name='授信总额')),
                ...
                ('entrusted_loan', models.FloatField(default=0, verbose_name='_委贷余额')),
                ('petty_loan', models.FloatField(default=0, verbose_name='小贷')),
                ('amount', models.FloatField(default=0, verbose_name='_在保总额')),
                ('g_value', models.FloatField(default=0, verbose_name='反担保价值')),
                ('g_radio', models.FloatField(default=0, verbose_name='授信覆盖率(%)')),
                ('v_radio', models.FloatField(default=0, verbose_name='在保覆盖率(%)')),
                ('custom_state', models.IntegerField(choices=[(11, '正常客户'), (21, '反担保客户'), (31, '小贷客户'), (99, '注销客户')], default=11, verbose_name='客户状态')),
                ('submission_status', models.IntegerField(choices=[(11, '未报送'), (21, '更新待报'), (31, '已报送')], default=11, verbose_name='客户状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('credit_code', models.CharField(blank=True, max_length=32, null=True, verbose_name='统一社会信用代码')),
                ('custom_nature', models.IntegerField(choices=[(11, '国有独资'), (21, '国有控股'), (31, '国有参股'), (41, '民营'), (51, '外资'), (61, '港澳台商独资'), (71, '其他')], default=41, verbose_name='企业性质')),
                ('industry_c', models.IntegerField(choices=[(101, '农林牧渔'), (102, '工业'), (103, '建筑业'), (104, '批发业'), (106, '零售业'), (107, '交通运输业'), (108, '仓储业'), (109, '邮政业'), (110, '住宿业'), (111, '餐饮业'), (112, '信息传输业'), (113, '软件和信息技术服务业'), (114, '房地产开发经营'), (115, '物业管理'), (116, '租赁和商务服务')], default=102, verbose_name='所属行业')),
                ('typing', models.IntegerField(choices=[(11, '涉农小微企业'), (21, '非农小薇企业'), (31, '中型企业'), (41, '大型企业')], default=21, verbose_name='企业划型')),
                ('capital', models.FloatField(default=0, verbose_name='注册资本')),
                ('paid_capital', models.FloatField(default=0, verbose_name='实收资本')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('household_nature', models.IntegerField(choices=[(1, '城镇居民'), (11, '农村居民')], default=1, verbose_name='户籍性质')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('due_date', models.DateField(verbose_name='到期日')),
                ('draft_state', models.IntegerField(choices=[(1, '未入库'), (2, '已入库'), (21, '置换出库'), (31, '解保出库'), (41, '托收出库'), (99, '已注销')], default=1, verbose_name='票据状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('up_date', models.DateField(default=datetime.date.today, verbose_name='跟新日期')),
                ('dun_stage', models.IntegerField(choices=[(1, '已代偿'), (3, '诉前'), (11, '一审'), (21, '上诉及再审'), (31, '案外之诉'), (41, '执行'), (51, '终本'), (91, '结案')], default=1, verbose_name='追偿状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('extension_amount', models.FloatField(default=0, verbose_name='展期金额')),
                ('extension_date', models.DateField(verbose_name='展期日')),
                ('extension_due_date', models.DateField(verbose_name='展期到期日')),
                ('extensiondate', models.DateField(default=datetime.date.today, verbose_name='_创建日期')),
            ],
            options={
                'verbose_name_plural': '放款-展期',
                'db_table': 'dbms_extension',
            },
        ),
        migrations.CreateModel(
            name='Feedback',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('housebag_app', models.IntegerField(choices=[(1, '住宅'), (5, '住宅、住宅地下室'), (11, '商业'), (12, '商业服务'), (13, '商业用房'), (21, '办公'), (31, '公寓'), (41, '生产性工业用房'), (42, '非生产性工业用房'), (43, '厂房'), (44, '工业性科研用房'), (45, '工业'), (46, '非生产性工业科研用房'), (47, '营业房'), (48, '研发中心'), (49, '研发楼'), (50, '研发车间'), (51, '科研'), (52, '车间'), (53, '消防通道'), (54, '倒班房'), (55, '倒班房及食堂'), (56, '农贸市场'), (57, '生产车间用房'), (58, '生产'), (59, '住宅、车库、住宅配套用房'), (61, '车库'), (62, '车位'), (63, '首层机动车停车场'), (64, '机动车库'), (65, '机动车停车库'), (71, '仓储'), (72, '仓储用房及配送用房'), (73, '物流配送中心用房'), (74, '连廊'), (75, '自行车库'), (76, '生产用房'), (77, '库房'), (81, '在建工程'), (91, '其他'), (99, '期房')], default=1, verbose_name='房产用途')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('house_app', models.IntegerField(choices=[(1, '住宅'), (5, '住宅、住宅地下室'), (11, '商业'), (12, '商业服务'), (13, '商业用房'), (21, '办公'), (31, '公寓'), (41, '生产性工业用房'), (42, '非生产性工业用房'), (43, '厂房'), (44, '工业性科研用房'), (45, '工业'), (46, '非生产性工业科研用房'), (47, '营业房'), (48, '研发中心'), (49, '研发楼'), (50, '研发车间'), (51, '科研'), (52, '车间'), (53, '消防通道'), (54, '倒班房'), (55, '倒班房及食堂'), (56, '农贸市场'), (57, '生产车间用房'), (58, '生产'), (59, '住宅、车库、住宅配套用房'), (61, '车库'), (62, '车位'), (63, '首层机动车停车场'), (64, '机动车库'), (65, '机动车停车库'), (71, '仓储'), (72, '仓储用房及配送用房'), (73, '物流配送中心用房'), (74, '连廊'), (75, '自行车库'), (76, '生产用房'), (77, '库房'), (81, '在建工程'), (91, '其他'), (99, '期房')], default=1, verbose_name='房产用途')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ind_typ', models.IntegerField(choices=[(1, '未分产业'), (11, '第一产业'), (21, '第二产业'), (31, '第三产业')], default=1, verbose_name='产业分类')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('i_classification', models.IntegerField(blank=True, choices=[(11, '正常'), (21, '关注'), (31, '次级'), (41, '可疑'), (51, '损失')], null=True, verbose_name='风险分类')),
                ('inv_date', models.DateField(default=datetime.date.today, verbose_name='补调日期')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sure_typ', models.IntegerField(choices=[(1, '企业保证'), (2, '个人保证'), (11, '房产抵押'), (12, '土地抵押'), (13, '动产抵押'), (14, '在建工程抵押'), (15, '车辆抵押'), (21, '房产顺位抵押'), (22, '土地顺位抵押'), (23, '在建工程顺位抵押'), (24, '动产顺位抵押'), (31, '应收质押'), (32, '股权质押'), (33, '票据质押'), (34, '动产质押'), (39, '其他权利质押'), (42, '房产监管'), (43, '土地监管'), (44, '票据监管'), (47, '动产监管'), (49, '其他监管'), (51, '股权预售'), (52, '房产预售'), (53, '土地预售'), (59, '其他')], verbose_name='担保类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('letter_typ', models.IntegerField(choices=[(1, '履约保函'), (11, '投标保函'), (21, '预付款保函'), (31, '质量与维修保函')], verbose_name='保函类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('provide_typ', models.IntegerField(choices=[(1, 'D-流贷'), (11, 'D-承兑'), (21, 'D-保函'), (31, 'D-委贷'), (41, 'X-过桥贷'), (52, 'X-房抵贷'), (53, 'X-担保贷'), (55, 'X-经营贷'), (57, 'X-票据贷'), (58, 'X-消费贷')], verbose_name='放款种类')),
                ...
                ('provide_status', models.IntegerField(choices=[(1, '在保'), (11, '解保'), (15, '展期'), (21, '代偿')], default=1, verbose_name='放款状态')),
                ...
                ('fication', models.IntegerField(choices=[(11, '正常'), (21, '关注'), (31, '次级'), (41, '可疑'), (51, '损失')], default=11, verbose_name='风险分类')),
                ('fic_date', models.DateField(default=datetime.date.today, verbose_name='分类日期')),
                ('obj_typ', models.IntegerField(choices=[(1, '农户贷款'), (11, '关联企业或个体工商户贷款'), (15, '个人消费贷款'), (21, '农村企业贷款'), (23, '城市-小微企业'), (25, '城市-其他企业'), (99, '其他')], default=99, verbose_name='贷款对象分类')),
                ('credit_typ', models.IntegerField(choices=[(1, '纯信用贷款'), (11, '抵押贷款'), (15, '质押贷款'), (21, '保证贷款'), (99, '其他')], default=99, verbose_name='信用形式分类')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('repayment_money', models.FloatField(default=0, verbose_name='当期还款本金额')),
                ('repayment_int', models.FloatField(default=0, verbose_name='当期还款利息额')),
                ('repayment_pen', models.FloatField(default=0, verbose_name='当期还款违约金额')),
                ('repayment_amt', models.FloatField(default=0, verbose_name='当期还款总额额')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('result_typ', models.IntegerField(choices=[(11, '股东会决议'), (13, '合伙人会议决议'), (15, '举办者会议决议'), (21, '董事会决议'), (23, '管委会决议'), (31, '财产声明书'), (41, '个人婚姻状况及财产申明'), (51, '承诺函'), (52, '承租人承诺书'), (99, '其他协议')], verbose_name='决议类型')),
                ...
                ('agree', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='result_agree', to='A_dbms.Agrees', verbose_name='主合同')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plan_date', models.DateField(blank=True, null=True, verbose_name='台账日期')),
                ('review_plan_date', models.DateField(blank=True, null=True, verbose_name='保后计划')),
                ('review_state', models.IntegerField(choices=[(1, '待保后'), (11, '待报告'), (21, '已完成'), (81, '自主保后'), (91, '无需保后')], default=1, verbose_name='_保后状态')),
                ('plan_sty', models.IntegerField(blank=True, choices=[(1, '现场检查'), (11, '电话回访'), (61, '补调替代'), (62, '尽调替代'), (91, '无需保后')], null=True, verbose_name='计划方式')),
                ('review_sty', models.IntegerField(blank=True, choices=[(1, '现场检查'), (11, '电话回访'), (61, '补调替代'), (62, '尽调替代'), (91, '无需保后')], null=True, verbose_name='保后方式')),
                ('book', models.TextField(blank=True, null=True, verbose_name='专员台账')),
                ('analysis', models.TextField(blank=True, null=True, verbose_name='风险分析')),
                ('suggestion', models.TextField(blank=True, null=True, verbose_name='风控建议')),
                ('classification', models.IntegerField(blank=True, choices=[(11, '正常'), (21, '关注'), (31, '次级'), (41, '可疑'), (51, '损失')], null=True, verbose_name='风险分类')),
                ('review_date', models.DateField(blank=True, null=True, verbose_name='保后日期')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('credit_model', models.IntegerField(choices=[(1, '流动资金贷款'), (2, '银行承兑汇票敞口'), (3, '保函'), (4, '综合授信额度（含流贷、银承、保函）'), (31, '委托贷款'), (41, '按揭贷款')], default=1, verbose_name='授信类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('track_typ', models.IntegerField(choices=[(11, '日常计划'), (21, '分期还本'), (25, '等额本息'), (31, '按月付息')], default=11, verbose_name='计划类型')),
                ('plan_date', models.DateField(verbose_name='计划日期')),
                ('proceed', models.CharField(max_length=128, verbose_name='跟踪内容')),
                ('term_pri', models.FloatField(default=0, verbose_name='应收当期本金')),
                ('term_int', models.FloatField(default=0, verbose_name='应收当期利息')),
                ('term_pen', models.FloatField(default=0, verbose_name='应收当期违约金')),
                ('term_amt', models.FloatField(default=0, verbose_name='应收当期总额')),
                ('ddd_pro', models.DateField(blank=True, null=True, verbose_name='起始日期')),
                ('pro_aft_dif', models.IntegerField(default=0, verbose_name='计息天数')),
                ('total_int', models.FloatField(default=0, verbose_name='利息累计')),
                ('prin', models.FloatField(default=0, verbose_name='剩余本金')),
                ('term_int_j', models.FloatField(default=0, verbose_name='计息本金')),
                ('term_pried', models.FloatField(default=0, verbose_name='已收当期本金')),
                ('term_inted', models.FloatField(default=0, verbose_name='已收当期利息')),
                ('term_pened', models.FloatField(default=0, verbose_name='已收当期违约金')),
                ('term_amted', models.FloatField(default=0, verbose_name='已收当期总额')),
                ...
                ('track_state', models.IntegerField(choices=[(11, '未结清'), (21, '已结清')], default=11, verbose_name='计划状态')),
                ('trackordate', models.DateField(default=datetime.date.today, verbose_name='_创建日期')),
                ('provide', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='track_provide', to='A_dbms.Provides', verbose_name='放款')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ex_condition', models.TextField(blank=True, null=True, verbose_name='备注')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vehicle_brand', models.CharField(max_length=64, verbose_name='车辆类型')),
        ...
        migrations.AddField(
            model_name='trackex',
            name='ex_trackor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='ex_employee', to=settings.AUTH_USER_MODEL, verbose_name='_创建者'),
        ),
        migrations.AddField(
            model_name='trackex',
            name='track',
        ...
        migrations.AddField(
            model_name='patent',
            name='patentor',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.PROTECT, related_name='patentor_employee', to=settings.AUTH_USER_MODEL, verbose_name='创建者'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='fication',
            name='ficationor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='ficationor_employee', to=settings.AUTH_USER_MODEL, verbose_name='分类人员'),
        ),
        migrations.AddField(
            model_name='fication',
            name='provide',
        ...
        migrations.AddField(
            ...
            name='extensionor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='extensionor_employee', to=settings.AUTH_USER_MODEL, verbose_name='_创建者'),
        ),
        migrations.AddField(
            model_name='extension',
            name='provide',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='extension_provide', to='A_dbms.Provides', verbose_name='_放款'),
        ),
        migrations.AddField(
            model_name='experts',
            name='expertor',
        ...
        migrations.AddField(
            model_name='customes',
            name='controler',
            field=models.ForeignKey(default=1, limit_choices_to={'job__name': '风控专员'}, on_delete=django.db.models.deletion.PROTECT, related_name='controler_employee', to=settings.AUTH_USER_MODEL, verbose_name='风控专员'),
        ),
        migrations.AddField(
            model_name='customes',
            name='custom_buildor',
        ...
        migrations.AddField(
            model_name='customes',
            name='managementor',
            field=models.ForeignKey(default=1, limit_choices_to={'job__name': '项目经理'}, on_delete=django.db.models.deletion.PROTECT, related_name='manage_employee', to=settings.AUTH_USER_MODEL, verbose_name='管护经理'),
        ),
        migrations.AddField(
