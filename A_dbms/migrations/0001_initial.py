    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.ForeignKey(limit_choices_to=A_dbms.models.m_appraisal.limit_lending_choices, on_delete=django.db.models.deletion.PROTECT, related_name='lending_summary', to='A_dbms.Articles', verbose_name='纪要')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='stockes',
            name='warrant',
            field=models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='stock_warrant', to='A_dbms.Warrants', verbose_name='权证'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='warrant',
            field=models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='receive_warrant', to='A_dbms.Warrants', verbose_name='权证'),
        ),
        migrations.AddField(
