    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('counter_typ', models.IntegerField(choices=[(0, '--------'), (1, '企业担保'), (2, '个人担保'), (3, '房产抵押'), (4, '土地抵押'), (5, '应收质押'), (6, '动产抵押'), (7, '车辆抵押')], verbose_name='合同类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('warrant_typ', models.IntegerField(choices=[(1, '房产'), (2, '土地'), (3, '应收'), (4, '股权'), (5, '票据'), (6, '车辆'), (7, '其他'), (8, '他权')], default=1, verbose_name='权证类型')),
                ...
                ('warrant_state', models.IntegerField(choices=[(1, '未入库'), (2, '已入库'), (3, '已出库'), (4, '已借出'), (5, '已归还'), (6, '已注销')], default=1, verbose_name='_权证状态')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='article_buildor_employee', to=settings.AUTH_USER_MODEL, verbose_name='创建人'),
        ),
        migrations.AddField(
            model_name='articles',
            name='assistant',
