# Generated by Django 2.1.3 on 2019-02-25 00:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agent_term', models.IntegerField(blank=True, null=True, verbose_name='代理期限(年)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parrent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='carte_parrent', to='A_dbms.Cartes', verbose_name='母菜单')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('charge_type', models.IntegerField(choices=[(1, '律师代理费'), (11, '案件受理费'), (21, '财产保全费'), (31, '执行费'), (41, '公告费'), (99, '其他费用')], verbose_name='费用类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dun_state', models.IntegerField(choices=[(1, '已代偿'), (11, '已起诉'), (21, '已判决'), (31, '已和解'), (41, '执行中'), (91, '结案')], default=1, verbose_name='追偿状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dun_stage', models.IntegerField(choices=[(1, '起诉'), (11, '判决'), (21, '执行'), (31, '和解结案'), (41, '终止执行'), (99, '注销')], default=1, verbose_name='追偿状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('house_app', models.IntegerField(choices=[(1, '住宅'), (11, '商业'), (21, '办公'), (31, '公寓'), (41, '生产性工业用房'), (51, '科研'), (52, '车间'), (53, '消防通道'), (61, '车库'), (71, '仓储'), (99, '期房')], default=1, verbose_name='房产用途')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('inquiry_type', models.IntegerField(choices=[(1, '日常跟踪'), (5, '拍卖挂网'), (11, '拍卖成交'), (21, '拍卖流拍'), (31, '执行回转'), (99, '注销')], default=1, verbose_name='查询类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('judgment_file', models.CharField(max_length=64, verbose_name='文件编号')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('seal_state', models.IntegerField(choices=[(1, '诉前保全'), (5, '首次首封'), (11, '首次轮封'), (21, '续查封'), (51, '解除查封'), (99, '注销')], verbose_name='查封状态')),
                ('seal_date', models.DateField(blank=True, null=True, verbose_name='最近查封日')),
                ('due_date', models.DateField(blank=True, null=True, verbose_name='查封到期日')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sealup_type', models.IntegerField(choices=[(1, '诉前保全'), (5, '首次首封'), (11, '首次轮封'), (21, '续查封'), (51, '解除查封'), (99, '注销')], default=1, verbose_name='查封类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('staff_type', models.IntegerField(choices=[(1, '代理律师'), (11, '审判法官'), (21, '执行法官'), (31, '评估人员'), (41, '代理员工'), (51, '助拍人员'), (99, '其他人员')], verbose_name='人员类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('stage_type', models.IntegerField(choices=[(1, '还款承诺'), (5, '起诉'), (11, '受理'), (15, '财产保全'), (21, '和解'), (25, '调解'), (31, '判决'), (32, '上诉'), (41, '执行'), (43, '执行异议'), (51, '资料递交'), (91, '公告'), (99, '其他')], verbose_name='阶段')),
                ('stage_file', models.CharField(max_length=64, verbose_name='文件')),
                ('stage_date', models.DateField(verbose_name='文件日期')),
                ('stage_remark', models.CharField(blank=True, max_length=64, null=True, verbose_name='备注')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inquiry_remark', models.CharField(blank=True, max_length=64, null=True, verbose_name='查询情况')),
                ...
                ('auction_state', models.IntegerField(choices=[(1, '正常'), (5, '挂网'), (11, '成交'), (21, '流拍'), (31, '回转'), (99, '注销')], default=1, verbose_name='_拍卖状态')),
        ...
        migrations.AddField(
            model_name='seal',
            name='sealor',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.PROTECT, related_name='sealor_employee', to=settings.AUTH_USER_MODEL, verbose_name='创建人'),
        ),
        migrations.AddField(
            model_name='seal',
            name='warrant',
