# Generated by Django 2.1.7 on 2019-10-16 11:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agree_name', models.IntegerField(choices=[(1, '委托保证合同'), (11, '最高额委托保证合同'), (21, '委托出具分离式保函合同'), (22, '开立保函合同'), (31, '借款合同'), (41, '委托贷款合同')], verbose_name='合同种类')),
                ('num_prefix', models.CharField(max_length=32, verbose_name='_编号前缀')),
                ('agree_term', models.IntegerField(verbose_name='合同期限（月）')),
                ('agree_typ', models.IntegerField(choices=[(1, '单笔'), (2, '最高额'), (4, '委贷'), (7, '小贷'), (21, '分离式保函'), (22, '公司保函'), (23, '银行保函'), (41, '单笔(公证)'), (42, '最高额(公证)'), (47, '小贷(公证)')], verbose_name='合同种类')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article_typ', models.IntegerField(choices=[(1, '担保'), (5, '小贷'), (11, '租赁'), (21, '保险')], default=1, verbose_name='_项目状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('housebag_app', models.IntegerField(choices=[(1, '住宅'), (11, '商业'), (21, '办公'), (31, '公寓'), (41, '生产性工业用房'), (42, '非生产性工业用房'), (43, '厂房'), (44, '工业性科研用房'), (45, '工业'), (46, '非生产性工业科研用房'), (47, '营业房'), (48, '研发中心'), (49, '研发楼'), (51, '科研'), (52, '车间'), (53, '消防通道'), (54, '倒班房'), (61, '车库'), (62, '车位'), (63, '首层机动车停车场'), (64, '机动车库'), (64, '机动车停车库'), (71, '仓储'), (72, '仓储用房及配送用房'), (73, '物流配送中心用房'), (74, '连廊'), (75, '自行车库'), (76, '生产用房'), (77, '库房'), (81, '在建工程'), (91, '其他'), (99, '期房')], default=1, verbose_name='房产用途')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('house_app', models.IntegerField(choices=[(1, '住宅'), (11, '商业'), (21, '办公'), (31, '公寓'), (41, '生产性工业用房'), (42, '非生产性工业用房'), (43, '厂房'), (44, '工业性科研用房'), (45, '工业'), (46, '非生产性工业科研用房'), (47, '营业房'), (48, '研发中心'), (49, '研发楼'), (51, '科研'), (52, '车间'), (53, '消防通道'), (54, '倒班房'), (61, '车库'), (62, '车位'), (63, '首层机动车停车场'), (64, '机动车库'), (64, '机动车停车库'), (71, '仓储'), (72, '仓储用房及配送用房'), (73, '物流配送中心用房'), (74, '连廊'), (75, '自行车库'), (76, '生产用房'), (77, '库房'), (81, '在建工程'), (91, '其他'), (99, '期房')], default=1, verbose_name='房产用途')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inv_date', models.DateField(default=datetime.date(2019, 10, 16), verbose_name='补调日期')),
