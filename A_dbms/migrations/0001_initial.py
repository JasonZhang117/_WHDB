# Generated by Django 2.1.3 on 2018-12-22 07:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ground_app', models.IntegerField(choices=[(1, '住宅用地'), (2, '商服用地'), (3, '工业用地')], default=1, verbose_name='用途')),
                ('ground_area', models.FloatField(verbose_name='面积')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('house_locate', models.CharField(max_length=64, unique=True, verbose_name='坐落')),
                ('house_app', models.IntegerField(choices=[(1, '住宅'), (2, '商业'), (3, '办公'), (4, '公寓'), (5, '厂房'), (6, '非生产性工业科研用房')], default=1, verbose_name='用途')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('warrant_num', models.CharField(max_length=32, unique=True, verbose_name='编号')),
                ('warrant_typ', models.IntegerField(choices=[(1, '房产'), (2, '土地'), (3, '车辆'), (4, '设备'), (5, '存货'), (6, '权利'), (7, '应收'), (8, '股权'), (9, '他权')], default=1, verbose_name='权证类型')),
