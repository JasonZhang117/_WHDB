    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agree_order', models.IntegerField(verbose_name='合同序号')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article_state', models.IntegerField(choices=[(1, '待反馈'), (2, '待上会'), (3, '已上会'), (4, '无补调'), (5, '需补调'), (6, '已补调'), (7, '已签批')], default=1, verbose_name='项目状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='employee_department', to='A_dbms.Departments', verbose_name='部门')),
