# Generated by Django 2.1.3 on 2019-01-02 05:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agree_state', models.IntegerField(choices=[(1, '待签批'), (2, '已签批'), (3, '已落实'), (4, '已放款'), (7, '待变更'), (8, '已解保'), (9, '已作废')], default=1, verbose_name='_合同状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('counter_typ', models.IntegerField(choices=[(1, '企业担保'), (2, '个人保证'), (11, '房产抵押'), (12, '土地抵押'), (13, '设备抵押'), (14, '存货抵押'), (15, '车辆抵押'), (31, '应收质押'), (32, '股权质押'), (33, '票据质押'), (51, '股权预售'), (52, '房产预售'), (53, '土地预售')], verbose_name='合同类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('custome', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='company_custome', to='A_dbms.Customes', verbose_name='企业客户')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('custome', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='person_custome', to='A_dbms.Customes', verbose_name='个人客户')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('propose', models.IntegerField(choices=[(1, '符合上会条件'), (2, '暂不符合上会条件'), (3, '建议终止项目')], default=0, verbose_name='上会建议')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ground_app', models.IntegerField(choices=[(1, '住宅'), (2, '商住'), (3, '商服'), (4, '工业')], default=1, verbose_name='土地用途')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('house_app', models.IntegerField(choices=[(1, '住宅'), (2, '商业'), (3, '办公'), (4, '公寓'), (5, '厂房'), (6, '科研')], default=1, verbose_name='房产用途')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('agree', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='ypothec_agree', to='A_dbms.Agrees', verbose_name='委托合同')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.ForeignKey(limit_choices_to=A_dbms.models.m_appraisal.limit_lending_choices, on_delete=django.db.models.deletion.PROTECT, related_name='lending_summary', to='A_dbms.Articles', verbose_name='项目纪要')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sure_typ', models.IntegerField(choices=[(1, '企业保证'), (2, '个人保证'), (11, '房产抵押'), (12, '土地抵押'), (13, '设备抵押'), (14, '存货抵押'), (15, '车辆抵押'), (21, '房产顺位'), (22, '土地顺位'), (31, '应收质押'), (32, '股权质押'), (33, '票据质押'), (41, '合格证监管'), (42, '房产监管'), (43, '土地监管'), (51, '股权预售'), (52, '房产预售'), (53, '土地预售')], verbose_name='担保类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('provide_status', models.IntegerField(choices=[(1, '在保'), (2, '解保'), (3, '代偿')], default=1, verbose_name='放款状态')),
                ('notify', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='provide_notify', to='A_dbms.Notify', verbose_name='放款通知')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('stock_typ', models.IntegerField(choices=[(1, '有限公司股权'), (2, '股份公司股份'), (3, '举办者权益')], default=1, verbose_name='股权性质')),
                ('target', models.CharField(max_length=64, verbose_name='标的公司')),
                ('share', models.FloatField(verbose_name='数量（万元/万股）')),
                ('stock_owner', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='stock_owner_custome', to='A_dbms.Customes', verbose_name='所有权人')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('storage_typ', models.IntegerField(choices=[(1, '入库'), (2, '出库'), (3, '借出'), (4, '归还'), (5, '解保')], default=1, verbose_name='出入库')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('warrant_num', models.CharField(max_length=32, unique=True, verbose_name='权证编码')),
                ('warrant_typ', models.IntegerField(choices=[(1, '房产'), (2, '土地'), (3, '应收'), (4, '股权'), (5, '票据'), (6, '车辆'), (7, '其他'), (9, '他权')], default=1, verbose_name='权证类型')),
                ...
                ('warrant_state', models.IntegerField(choices=[(1, '未入库'), (2, '已入库'), (3, '已出库'), (4, '已借出'), (5, '已注销')], default=1, verbose_name='_权证状态')),
            ],
            options={
                'db_table': 'dbms_warrants',
                'verbose_name_plural': '权证-权证',
            },
        ),
        migrations.CreateModel(
            name='Employees',
        ...
        migrations.AddField(
            model_name='vehicle',
            name='warrant',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='vehicle_warrant', to='A_dbms.Warrants', verbose_name='权证'),
        ),
        migrations.AddField(
            model_name='storages',
            name='conservator',
        ...
        migrations.AddField(
            model_name='draft',
            name='warrant',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='draft_warrant', to='A_dbms.Warrants', verbose_name='权证'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='counter_employee', to=settings.AUTH_USER_MODEL, verbose_name='创建者'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='chattel',
            name='warrant',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='chattel_warrant', to='A_dbms.Warrants', verbose_name='权证'),
        ),
        migrations.AddField(
            model_name='branches',
            name='cooperator',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='article_buildor_employee', to=settings.AUTH_USER_MODEL, verbose_name='创建者'),
        ),
        migrations.AddField(
            model_name='articles',
            name='assistant',
