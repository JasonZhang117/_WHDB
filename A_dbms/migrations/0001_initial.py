# Generated by Django 2.1.3 on 2018-11-16 05:32
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agree_typ', models.IntegerField(choices=[(1, '单笔'), (2, '最高额')], default=1, verbose_name='合同种类')),
                ('agree_amount', models.FloatField(verbose_name='合同金额')),
                ('agree_state', models.IntegerField(choices=[(1, '未签订'), (2, '已签订'), (3, '已落实'), (4, '已作废')], default=1, verbose_name='_合同状态')),
                ('agree_balance', models.FloatField(default=0, verbose_name='_放款余额')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article_date', models.DateField(default=datetime.date.today, verbose_name='提交日期')),
                ('article_state', models.IntegerField(choices=[(1, '待反馈'), (2, '待上会'), (3, '无补调'), (4, '需补调'), (5, '已补调'), (6, '已签批')], default=1, verbose_name='项目状态')),
                ('review_model', models.IntegerField(blank=True, choices=[(1, '内审'), (2, '外审')], null=True, verbose_name='评审类型')),
                ('review_order', models.IntegerField(blank=True, null=True, verbose_name='评审次序')),
                ...
                ('flow_credit', models.FloatField(blank=True, null=True, verbose_name='流贷额度（元）')),
                ('flow_rate', models.FloatField(blank=True, null=True, verbose_name='流贷费率（%）')),
                ('honour_credit', models.FloatField(blank=True, null=True, verbose_name='承兑额度（元）')),
                ('honour_rate', models.FloatField(blank=True, null=True, verbose_name='承兑费率（%）')),
                ('accept_credit', models.FloatField(blank=True, null=True, verbose_name='保函额度（元）')),
                ('accept_rate', models.FloatField(blank=True, null=True, verbose_name='保函费率（%）')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('compensatory_num', models.CharField(max_length=32, unique=True, verbose_name='代偿编号')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flow_credit', models.FloatField(default=0, verbose_name='流贷额度（元）')),
                ('back_credit', models.FloatField(default=0, verbose_name='保函额度（元）')),
                ('flow_loan', models.FloatField(default=0, verbose_name='流贷放款（元）')),
                ('accept_loan', models.FloatField(default=0, verbose_name='承兑放款（元）')),
                ('back_loan', models.FloatField(default=0, verbose_name='保函放款（元）')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.IntegerField(choices=[(1, '一级'), (2, '二级')], default=1, verbose_name='级别')),
        ...
        migrations.AddField(
            model_name='jobs',
            name='menus',
            field=models.ManyToManyField(blank=True, to='A_dbms.Menus', verbose_name='姓名'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='articles',
            name='expert',
            field=models.ManyToManyField(related_name='article_expert', to='A_dbms.Experts', verbose_name='评审'),
        ),
        migrations.AddField(
            model_name='agrees',
            name='article',
