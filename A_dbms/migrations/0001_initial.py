# Generated by Django 2.1.3 on 2019-04-08 06:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agree_name', models.CharField(blank=True, max_length=16, null=True, verbose_name='_合同名称')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('chattel_typ', models.IntegerField(choices=[(1, '存货'), (11, '机器设备'), (21, '合格证'), (31, '专利'), (41, '商标'), (71, '账户'), (99, '其他')], default=1, verbose_name='动产种类')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('counter_name', models.CharField(blank=True, max_length=32, null=True, verbose_name='_合同名称')),
                ('counter_typ', models.IntegerField(choices=[(1, '企业担保'), (2, '个人保证'), (11, '房产抵押'), (12, '土地抵押'), (13, '动产抵押'), (14, '在建工程抵押'), (15, '车辆抵押'), (31, '应收质押'), (32, '股权质押'), (33, '票据质押'), (34, '动产质押'), (41, '其他权利质押'), (51, '股权预售'), (52, '房产预售'), (53, '土地预售')], verbose_name='合同类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entrusted_loan', models.FloatField(default=0, verbose_name='_委贷余额')),
                ('petty_loan', models.FloatField(default=0, verbose_name='_小贷余额')),
                ('custom_state', models.IntegerField(choices=[(1, '正常'), (99, '注销')], default=1, verbose_name='_风险分类')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('evaluate_state', models.IntegerField(choices=[(1, '机构评估'), (11, '机构预估'), (21, '综合询价'), (31, '购买成本'), (41, '拍卖评估'), (99, '无需评估')], default=1, verbose_name='评估方式')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('house_app', models.IntegerField(choices=[(1, '住宅'), (11, '商业'), (21, '办公'), (31, '公寓'), (41, '生产性工业用房'), (42, '非生产性工业用房'), (51, '科研'), (52, '车间'), (53, '消防通道'), (61, '车库'), (71, '仓储'), (81, '在建工程'), (91, '其他'), (99, '期房')], default=1, verbose_name='房产用途')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sure_typ', models.IntegerField(choices=[(1, '企业保证'), (2, '个人保证'), (11, '房产抵押'), (12, '土地抵押'), (13, '动产抵押'), (14, '在建工程抵押'), (15, '车辆抵押'), (21, '房产顺位'), (22, '土地顺位'), (23, '在建工程顺位'), (24, '动产顺位'), (31, '应收质押'), (32, '股权质押'), (33, '票据质押'), (34, '动产质押'), (39, '其他权利质押'), (42, '房产监管'), (43, '土地监管'), (44, '票据监管'), (47, '动产监管'), (49, '其他监管'), (51, '股权预售'), (52, '房产预售'), (53, '土地预售')], verbose_name='担保类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('other_typ', models.IntegerField(choices=[(11, '购房合同'), (21, '合格证'), (31, '专利'), (41, '商标'), (71, '账户'), (99, '其他')], default=99, verbose_name='资产总类')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('evaluate_state', models.IntegerField(blank=True, choices=[(1, '机构评估'), (11, '机构预估'), (21, '综合询价'), (31, '购买成本'), (41, '拍卖评估'), (99, '无需评估')], null=True, verbose_name='评估方式')),
                ('evaluate_value', models.FloatField(blank=True, null=True, verbose_name='评估价值')),
                ('evaluate_date', models.DateField(blank=True, null=True, verbose_name='评估日期')),
                ('evaluate_explain', models.CharField(blank=True, max_length=128, null=True, verbose_name='评估说明')),
