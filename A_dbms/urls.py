...
urlpatterns = [
    ...
    path('agree/preview/supple/<int:agree_id>/', views.supplementary_preview, name='agree_supple_preview'),
    ...
    path('agree/preview/letter/<int:agree_id>/<int:warrant_id>/', views.letter_knowing, name='agree_letter_preview'),
    ...
    path('agree/supple/save/', views.supple_save_ajax, name='agree_supple_save_ajax'),
    ...
    path('report/meeting/provide/follow/', views.provide_follow_list, name='report_follow_list'),
